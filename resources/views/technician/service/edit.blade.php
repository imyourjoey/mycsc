<x-layout>
  ...
  <div class="container">
      ...
      <div class="mt-4 mb-4">
        ...
        <div class="row">
            <div class="form-group col-md-6">
                <a href="{{ route('technician.service.index') }}">
    ...
    @endif
      ...
      <form method="POST" action={{ route('technician.service.update',['service' => $service->serviceID]) }} id="createUserForm" enctype="multipart/form-data">
          @csrf
          <div class="row">
              <div class="form-group col-md-6">
          ...
          <div class="row">
              <div class="form-group col-md-6">
                  <br>
                  <button type="submit" class="btn btn-primary btn-block">Edit <i class="fa fa-arrow-right"
