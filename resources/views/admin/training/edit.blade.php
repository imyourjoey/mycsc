<x-layout>
    ...
    <div class="container">
        ...
        <div class="mt-4 mb-4">
          ...
          @endif
            <p class="h2">Edit Training Programme</p>
            <p>Please update the following information to edit the training programme.</p>
        </div>

        <form method="POST" action="{{ route('admin.training.update', ['training' => $training->trainingID]) }}" id="editTrainingForm">
            @csrf
            @method('PUT') <!-- Use the PUT method to update the existing training -->
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="trainingTitle"
                        ...
                        value="{{ old('trainingTitle', $training->trainingTitle) }}">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <textarea type="text" class="form-control" id="trainingDesc"
                        placeholder="Provide a brief description of the training programme" name="trainingDesc"
                        rows="4">{{ old('trainingDesc', $training->trainingDesc) }}</textarea>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="trainingVenue"
                        ...
                        value="{{ old('trainingVenue', $training->trainingVenue) }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 pr-1">
                    ...
                    <input type="text" class="form-control" id="trainerName"
                        ...
                        value="{{ old('trainerName', $training->trainerName) }}">
                ...
                <div class="form-group col-md-3 pl-1">
                    ...
                    <input type="text" class="form-control" id="trainingCapacity"
                        ...
                        value="{{ old('trainingCapacity', $training->trainingCapacity) }}">
            ...
            <div class="row">
                <div class="form-group col-md-2 pr-1">
                    ...
                    <input type="text" class="form-control selector bg-white" value="{{ old('startDateTime', $training->startDateTime) }}" name="startDateTime" placeholder=" -Choose start date-">
                ...
                <div class="form-group col-md-2 pr-1 pl-1">
                    ...
                    <input type="text" class="form-control selector bg-white" id="endDateTime"
                        ...
                        value="{{ old('endDateTime', $training->endDateTime) }}">
                ...
                <div class="form-group col-md-2 pl-1">
                    ...
                    <input type="text" class="form-control selector bg-white" id="regisDeadline"
                        ...
                        value="{{ old('regisDeadline', $training->regisDeadline) }}">
