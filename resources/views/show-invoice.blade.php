...
#image-container {
	...
	<body class="mt-5" style="position: relative;" >
                ...
                <td>
                  ...
                  height="200px">
								...
								<td>
									...
									Created: {{ date('F j, Y', strtotime($invoice->invoiceCreatedAt)) }}<br />
									Due: {{ date('F j, Y', strtotime($invoice->invoiceDueDate)) }}
								</td>
							</tr>
						</table>
					</td>
      ...
      <small>This invoice is computer-generated and does not require a physical signature.
...
function Convert_HTML_To_PDF() {
    ...
    var elementHTML = document.querySelector("#invoice-box");
