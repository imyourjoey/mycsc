<x-layout>
  ...
  <div class="container-fluid">
      <div class="h1 ml-2 mt-4 mb-4 font-weight-bold">Announcement</div>
...
<script>
  $(function () {
      ...
      var table = $('#announcement-table').DataTable({
          ...
          ajax: {
              url: '{{ route('announcement.index') }}', // Change this route to the appropriate Announcement index route
              type: 'GET'
          },
          ...
          buttons: [
              ...
              },
              {
                  ...
                  action: function (e, dt, button, config) {
                      window.location = "{{ route('announcement.create') }}"; // Change this route to the appropriate Announcement create route
                  }
              },
              {
                  ...
                  action: function (e, dt, button, config) {
                      ...
                      if (selectedData) {
                          window.location = "{{ route('announcement.edit', ['announcement' => ':announcementID']) }}".replace(':announcementID', selectedData.announcementID); 
                      }
                  }
              },
              {
                  ...
                  action: function (e, dt, button, config) {
                      ...
                      if (confirm('Are you sure you want to delete the selected records?')) {
                          $.ajax({
                              url: "{{ route('announcement.destroy') }}", // Change this route to the appropriate Announcement destroy route
                              type: "DELETE",
