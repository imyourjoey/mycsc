<x-layout>
  ...
  <div class="container-fluid">
      <div class="h1 ml-2 mt-4 mb-4 font-weight-bold">Training</div>
...
<script>
  $(function () {
      ...
      var table = $('#training-table').DataTable({
          ...
          ajax: {
              url: '{{ route('training.index') }}', // Change this route to the appropriate Training index route
              type: 'GET'
          },
          ...
          buttons: [
              ...
              },
              {
                  ...
                  action: function (e, dt, button, config) {
                      window.location = "{{ route('training.create') }}"; // Change this route to the appropriate Training create route
                  }
              },
              {
                  ...
                  action: function (e, dt, button, config) {
                      ...
                      if (selectedData) {
                          window.location = "{{ route('training.edit', ['training' => ':trainingID']) }}".replace(':trainingID', selectedData.trainingID); // Change this route to the appropriate Training edit route
                      }
                  }
              },
              {
                  ...
                  action: function (e, dt, button, config) {
                      ...
                      if (confirm('Are you sure you want to delete the selected records?')) {
                          $.ajax({
                              url: "{{ route('training.destroy') }}", // Change this route to the appropriate Training destroy route
                              type: "DELETE",
