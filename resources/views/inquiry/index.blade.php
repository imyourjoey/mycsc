...
<script>
  $(function () {
      ...
      var table = $('#inquiry-table').DataTable({
          ...
          ajax: {
              url: '{{ route('inquiry.index') }}', // Change this route to the appropriate Inquiry index route
              type: 'GET'
          },
          ...
          buttons: [
              ...
              },
              {
                  ...
                  action: function (e, dt, button, config) {
                      window.location = "{{ route('inquiry.create') }}"; // Change this route to the appropriate Inquiry create route
                  }
              },
              {
                  ...
                  action: function (e, dt, button, config) {
                      ...
                      if (selectedData) {
                          window.location = "{{ route('inquiry.edit', ['inquiry' => ':inquiryID']) }}".replace(':inquiryID', selectedData.inquiryID); // Change this route to the appropriate Inquiry edit route
                      }
                  }
              },
              {
                  ...
                  action: function (e, dt, button, config) {
                      ...
                      if (confirm('Are you sure you want to delete the selected records?')) {
                          $.ajax({
                              url: "{{ route('inquiry.destroy') }}", // Change this route to the appropriate Inquiry destroy route
                              type: "DELETE",
