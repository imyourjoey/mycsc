...
<script>
  $(function () {
      ...
      var table = $('#feedback-table').DataTable({
          ...
          ajax: {
              url: '{{ route('feedback.index') }}', // Change this route to the appropriate Feedback index route
              type: 'GET'
          },
          ...
          buttons: [
              ...
              },
              {
                  ...
                  action: function (e, dt, button, config) {
                      window.location = "{{ route('feedback.create') }}"; // Change this route to the appropriate Feedback create route
                  }
              },
              {
                  ...
                  action: function (e, dt, button, config) {
                      ...
                      if (selectedData) {
                          window.location = "{{ route('feedback.edit', ['feedback' => ':feedbackID']) }}".replace(':feedbackID', selectedData.feedbackID); // Change this route to the appropriate Feedback edit route
                      }
                  }
              },
              {
                  ...
                  action: function (e, dt, button, config) {
                      ...
                      if (confirm('Are you sure you want to delete the selected records?')) {
                          $.ajax({
                              url: "{{ route('feedback.destroy') }}", // Change this route to the appropriate Feedback destroy route
                              type: "DELETE",
